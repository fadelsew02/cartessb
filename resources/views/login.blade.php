                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="index.html" class="logo d-flex align-items-center w-auto">
                                    <img src="assets/img/logosb.jpg" alt="">
                                    <span class="d-none d-lg-block">SB</span>
                                </a>
                            </div><!-- End Logo -->
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    @if (session()->has('error'))
                                        <div class="alert alert-danger my-2 text-center">{{ session('error') }} </div>
                                    @endif
                                    <form class="row g-3 needs-validation" action="/login-post" method="POST"
                                        novalidate>
                                        @csrf
                                        <div class="col-12">
